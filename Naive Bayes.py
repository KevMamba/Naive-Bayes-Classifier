...
data = pd.read_csv("C:/Users/kevin/Desktop/PES University/Junior Year/ML/MiniProject_Section_A/House-votes-data.TXT", 
                  sep=',', 
                  names=names)
...
def confusionmatrix(ypred,yobtained):
    cm=confusion_matrix(ypred,yobtained)
...
cv = KFold(n_splits=5, random_state=2, shuffle=False) #5 fold cross validation
max_acc=0
for train_index, test_index in cv.split(x):
    ...
    if acc>max_acc:
        ...
        maxrecall=recall
print(maxcm)
print("The Accuracy of the program is: ",max_acc*100)
print("The Precision of the program is: ",maxpres*100)
print("The Recall of the program is: ",maxrecall*100)
print("F meaure of the program is: ", 200*(maxpres*maxrecall)/(maxpres+maxrecall))